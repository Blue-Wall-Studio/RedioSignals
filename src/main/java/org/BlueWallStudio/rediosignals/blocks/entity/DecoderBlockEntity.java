package org.BlueWallStudio.rediosignals.blocks.entity;
...
import org.BlueWallStudio.rediosignals.blocks.DecoderBlock;
...
public class DecoderBlockEntity extends BlockEntity {
    ...
    public static void tick(World world, BlockPos ignoredPos, BlockState ignoredState, DecoderBlockEntity entity) {
        if (world.isClient)
            return;
     ...
     * [left, front, right]
     */
    public void receivePacket(Packet packet, Direction ignoredEntryDirection) {
