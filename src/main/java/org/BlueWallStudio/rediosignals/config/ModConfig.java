package org.BlueWallStudio.rediosignals.config;
...
import org.BlueWallStudio.rediosignals.WorldEventHandler;
import org.BlueWallStudio.rediosignals.packet.PacketManager;
import org.BlueWallStudio.rediosignals.debug.PacketVisualizer;
...
public class ModConfig {
    ...
    private static final String CONFIG_FILENAME = "rediosignals.json";
    ...
    private static ModConfig load() {
        if (CONFIG_FILE.exists()) {
            try (FileReader reader = new FileReader(CONFIG_FILE, StandardCharsets.UTF_8)) {
                ...
                System.err.println("Failed to load Redio Signals config: " + e.getMessage());
    ...
    public void save() {
        try {
            ...
            System.err.println("Failed to save Redio Signals config: " + e.getMessage());
        }
    }
